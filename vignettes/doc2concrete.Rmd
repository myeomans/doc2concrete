...
## Usage
 ...
 Here, we provide a single function, `doc2concrete`, that maps operationalize models of document-level concreteness based on a survey of datasets in several domains, including advice. This package is built as an accompaniment to Yeomans (2019), which reviews existing linguistic concreteness models across several domains. This function conducts two kinds of analyses, which can be selected using the `domain` argument. 
...
cor.test(doc2concrete(feedback_dat$feedback,domain="plans"),
         feedback_dat$concrete)
